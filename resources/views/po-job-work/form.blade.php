@extends('layouts.app')
@section('title', 'Po Supplier Entry')
@section('content')
...
<div class="bg-white rounded-2xl shadow border overflow-hidden">
    ...
    <div class="px-6 py-4 border-b flex justify-between items-center">
        ...
        <div class="text-sm text-slate-500">
            Doc # <strong>{{ $item->po_no }}</strong>
        </div>
    </div>

    <form action="{{ route('po.supplier.update', $item->id) }}" method="post">
        <div class="p-6 grid md:grid-cols-3 gap-3">
            ...
            <div>
                ...
                <input type="date" id="po_date" name="po_date" value="{{ $item->po_date }}" class="w-full border rounded-xl p-2.5">
            </div>
            <div>
        ...
        <div class="px-6 py-6">
            <button id="savePoSupplier" type="submit" class="bg-blue-600 text-white px-5 py-2.5 rounded-xl">
                Save
            </button>
            <button type="button" onclick="resetForm()" class="bg-slate-200 px-5 py-2.5 rounded-xl">
                Clear
            </button>
            <a href="{{ route('po.supplier.list') }}" class="bg-gray-600 text-white px-5 py-2.5 rounded-xl">
                Back 
            </a>
        </div>
    </form>
